# 🗳️ Greek Election System Simulation - Phase 02

[cite_start]Αυτό το project υλοποιεί μια προσομοίωση του ελληνικού εκλογικού συστήματος κατανομής βουλευτικών εδρών[cite: 8, 9]. [cite_start]Αναπτύχθηκε στα πλαίσια του μαθήματος **ΗΥ240: Δομές Δεδομένων** (Χειμερινό Εξάμηνο 2024-25) του Τμήματος Επιστήμης Υπολογιστών, στο Πανεπιστήμιο Κρήτης[cite: 1, 2, 3]. [cite_start]Αποτελεί το 2ο μέρος της προγραμματιστικής εργασίας του μαθήματος[cite: 4].
